...
public partial class DashBoardVM(ApplicationDbContext db, CurrentUserService currentUserService, 
    INavigatorService<AllSettingVM> settingNavigator,
    INavigatorService<AllNotificationVM> noteNavigator) : BaseViewModel
{
    private readonly ApplicationDbContext db = db;
    private readonly CurrentUserService currentUserService = currentUserService;
    private readonly INavigatorService<AllSettingVM> settingNavigator = settingNavigator;
    private readonly INavigatorService<AllNotificationVM> noteNavigator = noteNavigator;
    [ObservableProperty]
    ...
    private void RunTimer()
    {
        ...
        Timer.Start();
        TimerClock = DateTime.Now.ToString("HH:mm:ss");
    }
    ...
    {
        noteNavigator.Navigate("setting");
